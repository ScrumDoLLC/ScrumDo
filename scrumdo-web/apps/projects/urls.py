...
urlpatterns += patterns('projects.story_views',
    ...
    url(r'^project/(?P<group_slug>[-\w]+)/epic/(?P<epic_id>[0-9]+)/edit', 'edit_epic', name="edit_epic"),
    url(r'^project/(?P<group_slug>[-\w]+)/epic/(?P<epic_id>[0-9]+)/edit', 'edit_epic', name="delete_epic"),
