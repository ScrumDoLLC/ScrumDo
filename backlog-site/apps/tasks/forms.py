...
class TaskForm(forms.ModelForm):
    ...
    class Meta:
        model = Task
        fields = ('summary', 'detail', 'assignee', 'tags',  'points')
...
class EditTaskForm(forms.ModelForm):
    ...
    def __init__(self, user, group, *args, **kwargs):
        ...
        self.fields["assignee"].queryset = assignee_queryset.order_by("username")
        self.fields['summary'].widget.attrs["size"] = 65
        self.fields.keyOrder = ["summary","detail", "tags", "status", "assignee", "state","points"]
        
        
        self.fields["state"].choices = self.instance.STATE_CHOICES
    ...
    class Meta(TaskForm.Meta):
        fields = ('summary','detail','status', 'assignee', 'state', 'tags', 'points')
